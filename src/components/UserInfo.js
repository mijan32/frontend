...
export default function UserInfo({relyingPartyService}){
  ...
  const[poneNumber,setPhoneNumber]=useState(null);
  const [emailAddress, setEmailAddress] = useState(null);
  const[name,setName]=useState("")
  const navigate = useNavigate();
  const [imageSrc, setImageSrc] = useState('https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fGh1bWFufGVufDB8fDB8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=60');
...
const getUserDetails = async (authCode) => {
  ...
  try {
      ...
      console.log("userInfo",userInfo.phone_numbe);
          setAddress(userInfo.address);
          setEmailAddress(userInfo.email)
          setName(userInfo.name)
          setImageSrc(userInfo.picture)
  ...
  <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
    ...
    <img
      ...
      <div class="p-4">
        ...
        <h6 class="mt-3 font-medium">Founder and CEO email:{emailAddress}</h6>
